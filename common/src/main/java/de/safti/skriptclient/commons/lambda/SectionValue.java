package de.safti.skriptclient.commons.lambda;

import de.safti.skriptclient.utils.ParserUtils;
...
public abstract class SectionValue<S extends ArgumentSection, T> implements Expression<T> {
    ...
    public boolean init(Expression<?>[] expressions, int matchedPattern, ParseContext parseContext) {
        ...
        section = ParserUtils.getLinkedSection(parseContext.getParserState(), getSectionClass(), getSelectorFunction())
                .orElse(null);
        if (section == null) {
